...
@property (assign, nonatomic) BOOL backgroundMusicPlaying;
@property (assign, nonatomic) BOOL backgroundMusicInterrupted;
@property (assign, nonatomic) SystemSoundID pewPewSound;
